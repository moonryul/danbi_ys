...
public class Sierpinsky : MonoBehaviour {
  ...
  public void Rebuild() {
    ...
    Vector3 p1 = default, p2 = default, p3 = default, p4 = default;

    switch (type) {
      case FractalType.Sierpinsky_Triangle:
      p1 = new Vector3(0, 0, 0);
      p2 = new Vector3(1, 0, 0);
      p3 = new Vector3(0.5f, Mathf.Sqrt(0.75f), 0);
      ...
      p1 = new Vector3(0, 0, 0);
      p2 = new Vector3(1, 0, 0);
      p3 = new Vector3(0.5f, 0, Mathf.Sqrt(0.75f));
      p4 = new Vector3(0.5f, Mathf.Sqrt(0.75f), Mathf.Sqrt(0.75f) / 3);
